...
public class MultipleTrianglesImageConverter implements PrototypeToArrayConverter {
	...
	public MultipleTrianglesImageConverter(int[] buffer, BufferedImage image, Color clearColor, ImageEffectService service) {
		this.buffer = buffer;
		this.image = image;
